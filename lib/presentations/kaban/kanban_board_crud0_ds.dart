...
class KanbanBoardCRUD0DS extends StatefulWidget {
  final bool isCreate;
  final String title;
  ...
  const KanbanBoardCRUD0DS(
      ...
      : super(key: key);
  @override
  KanbanBoardCRUD0DSState createState() {
    return KanbanBoardCRUD0DSState();
    // return KanbanBoardCRUDDSState(public, active);
  }
}

class KanbanBoardCRUD0DSState extends State<KanbanBoardCRUD0DS> {
