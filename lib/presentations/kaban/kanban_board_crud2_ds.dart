...
class KanbanBoardCRUD2DS extends StatefulWidget {
  final bool isCreate;
  final String title;
  ...
  const KanbanBoardCRUD2DS(
      ...
      : super(key: key);
  @override
  KanbanBoardCRUD2DSState createState() {
    return KanbanBoardCRUD2DSState();
    // return KanbanBoardCRUD2DSState(public, active);
  }
}

class KanbanBoardCRUD2DSState extends State<KanbanBoardCRUD2DS> {
